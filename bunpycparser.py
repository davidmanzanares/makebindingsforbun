...
def file_to_dict(filename, preprocessor_extra):
    """ Load C file into dict representation of ast """
    if preprocessor_extra:
        args = preprocessor_extra.split(" ")+["""-Ivendor/pycparser-master/utils/fake_libc_include"""]
    else:
        args = "-Ivendor/pycparser-master/utils/fake_libc_include"
...
if __name__ == "__main__":
    if len(sys.argv) > 1:
        ...
        ast_dict = file_to_dict(sys.argv[1], sys.argv[3])
